...
文章間の相互参照関係(＝コピペ関係)をcsvおよびjsonファイルで出力できます。
...
エッジのアルファ値(透明度)が文の類似度、ノードのサイズがその文章が有する相互参照の数を表す。  
(ネットワーク図はCytoscapeで作成)  

## 技術的解説

そのうち書きます。表題の通りベクトル化には[SCDV](https://dheeraj7596.github.io/SDV/)を使用。
